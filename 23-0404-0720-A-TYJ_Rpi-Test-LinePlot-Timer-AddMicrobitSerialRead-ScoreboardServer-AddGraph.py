...
class update_WebGrid_UiTimer_Initialization_Class:
        def __init__(self):
            ...
            ###jwc 23-0522-0700 lagging 2 highcharts, so slow this down x2 = 8: self.timer_Sec_Int = 4
            ###jwc 23-0522-0710 improved to 20 sec updates, try x2 = 16: self.timer_Sec_Int = 8
            self.timer_Sec_Int = 16
...
###jwc y try /2: chart_HighChart_Update_LightDelta_Timer_Obj = ui.timer(4, chart_HighChart_Update_LightDelta_Fn, active=True)
###jwc n worst: try 8: chart_HighChart_Update_LightDelta_Timer_Obj = ui.timer(2, chart_HighChart_Update_LightDelta_Fn, active=True)
chart_HighChart_Update_LightDelta_Timer_Obj = ui.timer(8, chart_HighChart_Update_LightDelta_Fn, active=True)
