...
scoreboard_BotsAll_ArrayList_2D = [[]]
...
def update_line_plot() -> None:
    ...
    if x:
        ...
        network_DataNew_Message_Str = x
        if _debug_Show_Priority_Hi_Bool:
            ###jwc o serial.write_line replaced by 'print'
            print("* A")
            print("> " + network_DataNew_Message_Str)
        if True:
            ...
            for value in scoreboard_DataStrNew_ArrayList:
                value22 = value.substr(value.index_of(":") + 1, len(value))
            ...
            while index2 <= len(scoreboard_BotsAll_ArrayList_2D) - 1:
                ...
                if scoreboard_BotSingle_ArrayList_1D[0] == scoreboard_DataNumNew_ArrayList[0]:
                    ...
                    while index22 <= len(scoreboard_BotSingle_ArrayList_1D) - 1:
                        ...
                        if index22 != 0:
                            if _debug_Show_Priority_Hi_Bool:
                                printD[index22]) + " " + str(scoreboard_DataNumNew_ArrayList[index22]))
